...
- [~] `VIS-11` A Inércia em silhueta: quatro poses de uma figura preta, sem rosto, com fumaça — **M** — *pedido do chat em 2026-09-22. As imagens foram geradas pela equipe (chat, mesmo dia). **Decidido no chat, no mesmo dia:** a versão com o aviso quando ela age, e antes do `P7-09`. Em duas entregas: **a 1ª foi feita em 2026-09-22** — as quatro poses tratadas e a Inércia no passo dela do tutorial, no cartão da contenção e na tela de fim da derrota por apoio. **Falta a 2ª:** o aviso no boletim quando ela passa de 25, 50 e 75, sem pausar o jogo e sem ficar salvo. Sem nome além de "A Inércia" e sem fala inventada, porque o `docs/GDD.md §2.6` diz que ela não é vilão de bigode*
