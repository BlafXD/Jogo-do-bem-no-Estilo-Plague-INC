...
- [ ] `P3-01` `docs/CIENCIA.md`: fórmulas e constantes com fonte (IPCC AR6, Global Carbon Budget) — **M**
...
- [ ] `P4-06` **M1** — `SETUP-01` a `SETUP-07` concluídos e Pages no ar — **marco**
...
- [ ] `P6-01` `engine/state.ts`: tipos + estado inicial lido de `data/*.json` — **M**
...
- [ ] `P6-06` UI da árvore: pré-requisitos, custo, estado bloqueado/disponível/comprado — **G**
- [ ] `P6-07` Save, load e reset em `localStorage` — **M**
